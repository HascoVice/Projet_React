...
import "../components/reassur.css";
function Reassur() {
  return (
    <section className="wrap-reass">
      <div className="reassurance">
        ...
        <p className="rea-text">Par CB, Paypal, Chèque</p>
      </div>
      <div className="reassurance">
        <div className="flex-img">
          <div className="div-img">
        ...
        <p className="rea-text">Plus de 7000 produits</p>
      </div>
      <div className="reassurance">
        <div className="flex-img">
          <div className="div-img">
      ...
      <div className="reassurance">
        ...
        <p className="rea-text">Pour les commandes avant 13h</p>
      </div>
      <div className="reassurance">
        <div className="flex-img">
          <div className="div-img">
        ...
        <p className="rea-text">15 jours de délai pour tout retour</p>
      </div>
    </section>
  );
}

export default Reassur;
